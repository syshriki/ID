...
is ($factory->getFileContent('test.csv'),@fileContent,"checks content equality");
...
#Grabs built vendor list
my @built = $factory->getVendorList();
 
#There should be three objects in @built
is(scalar @built,3, "Checks buildVendorList count, and getVendorList accessor");
